function bdstec(Site,yr,doy,hrng,rate,minel)
%BDSTEC   BDS-TEC data processor
% BDSTEC('SITE',Y,D,H,R,MINEL,RDCB) processes the ground-based BDS observables
% in RINEX 2.00 or later and outputs the vertical TEC and the corresponding
...
%
% BDSTEC('SITE',Y,D,[H1 H2],R,MINEL) specifies the period in hours [H1 H2].
%
% For example,
%
%   BDSTEC('banc',2016,170,0,1,10)
%
...
%
%   BDSTEC('banc',2016,170,[0 24],30,20)
%
...
% Read in the station DCB
INFILE7 = 'DCB/STATION.DCB';
OUTFILE7 = 'STATION.mat';
