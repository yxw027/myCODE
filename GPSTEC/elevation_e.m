function el = elevation_e(Site,x,y,z,minel,Domes)
%ELEVATION_E   Calculate elevation angle for Galileo.
% EL = ELEVATION_E('SITE',X,Y,Z,MINEL) calculates the elevation angles EL of
% the satellites at [X, Y, Z] with respect to the Galileo site SITE in 4-char
% above the minimum (cutoff) elevation angle MINEL.  All angles are in degrees
% and all lengths are in km, ECF coordinate.
%
% For example, ELEVATION_E('coco',X,Y,Z,20) returns elevation angles greater
