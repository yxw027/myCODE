function [recdcb,satedcb] = getalldcb_c(Site,stec,el,ep,xi,yi,zi,Domes)
%GETALLDCB_C   Estimate differential code bias of BDS receiver and satellites.
% [RDCB, SDCB] = GETALLDCB_C('SITE',STEC,EL,EP,X,Y,Z) estimates the
% differential code biases (DCB) of the BDS receiver, RDCB, and satellites,
% SDCB, in nano-seconds for site, SITE in 4-char, with the given slant TEC,
% STEC in TECU, the corresponding elevation angles of satellites, EL in
% degrees, epochs EP in hours, XYZ positions of satellites in km.
%
% DCB = GETALLDCB_C(..., 'DOMES') further assigns the DOMES number.  The DOMES
...
f1 = 1.57542d9; % B1 frequency in Hz
