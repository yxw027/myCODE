...
% alt = height above ITRF2000 ellipsoid (m)
% x = ECEF X-coordinate (m)
% y = ECEF Y-coordinate (m)
% z = ECEF Z-coordinate (m)
%
% Notes: (1) This function assumes the ITRF2000 model (not WGS84).
...
%        (5) Michael Kleder, April 2006; Ho-Fang Tsai, November 2008
...
a = 6378137;
%e = 8.1819190842622e-2; % for WGS84
e = 8.181919104295e-2; % for ITRF2000, HF Tsai
