function sp32mat_c(w,wd)
%SP32MAT_C  Convert an SP3 file into a MAT-file for BDS satellites only.
% SP32MAT_C(W,WD) converts an SP3 file, named gbmwwwwd.sp3 or gbuwwwwd.sp3 into
% a MAT-file for GPS week W, and day of week WD.  Versions a and c are both
% acceptable.
...
W = num2str(w,'%04u');
WD = num2str(wd,'%01u');
nbds = 35; % Number of BDS satellites
...
gnss = id(1:2:end-1); % GNSS type, e.g., 'C' in ASCII
